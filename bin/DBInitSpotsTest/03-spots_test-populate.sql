/*
/home/doom/End/Cave/Spots/bin/DBInitSpotsTest/03-spots_test-populate.sql

SYNOPSIS

   cd /home/doom/End/Cave/Spots/bin/DBInitSpotsTest
   psql -d spots_test -f 03-spots_test-populate.sql
...
SELECT pg_catalog.setval('public.layout_id_seq', 56, true);
...
40	energy
41	sex
42	electoral_integrity
43	daily
44	politics_data
45	politics_left
46	politics_one_left
47	politics_mid
48	politics_libertarian
50	perl_news
51	perl_monks
57	san_francisco
58	oakland_talk
...
--
-- Name: categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: doom
--

SELECT pg_catalog.setval('public.categories_id_seq', 61, true);

--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: doom
--
...
--
-- Name: layout homepage_pkey; Type: CONSTRAINT; Schema: public; Owner: doom
--
...
--
-- Name: spots spot_pkey; Type: CONSTRAINT; Schema: public; Owner: doom
--
...
psql:03-spots_test-populate.sql:571: ERROR:  multiple primary keys for table "categories" are not allowed
psql:03-spots_test-populate.sql:579: ERROR:  multiple primary keys for table "layout" are not allowed
psql:03-spots_test-populate.sql:587: ERROR:  multiple primary keys for table "spots" are not allowed
psql:03-spots_test-populate.sql:594: ERROR:  trigger "row_mod_on_spot_trigger" for relation "spots" already exists
*/
