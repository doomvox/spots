...
Spots::AllCats - TODO Perl extension for blah blah blah

=head1 SYNOPSIS

   use Spots::AllCats ':all';

   TODO

=head1 DESCRIPTION

TODO  Stub documentation for Spots::AllCats,
...
BEGIN {
 ...
 qw(
  ...
  # The above allows declaration	use Spots::AllCats ':all';
