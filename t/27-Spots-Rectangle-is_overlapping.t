...
#   perl 27-Spots-Rectangle-is_overlapping.t
...
{  my $subname   = "is_overlapping";
   my $test_name = "Testing $subname, reversing order of comparison";
...
#     my $result = $rect1->is_overlapping( $rect2 );  #  17-Spots-Rectangle-is_overlapping.t
     my $result = $rect2->is_overlapping( $rect1 );
